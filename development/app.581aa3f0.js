...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/components/Filters.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/components/Restaurants.js":[function(require,module,exports) {
"use strict";
...
var Restaurants = function Restaurants() {
  var restaurants = [{
    ...
    restaurant: 'Bin22',
    description: 'Bottle shop/specialty grocer is open, offering curbside pick up and home delivery',
    hours: '',
    phone: '',
    ...
    description: "Bubba's will be offering to-go orders only at this time. We will be open from 7AM - 8PM daily. Please call your to-go order in and let us know when you arrive. We will bring it out to you! We encourage people to leave a 20% tip for our staff during this time as many of them are out of work.",
    ...
    description: 'Special family-style dinners will be added to the menu daily until sold out.',
    ...
    restaurant: 'Hatch',
    description: 'Please note that the takeout menu is slightly reduced. Breakfast and lunch items are available from 11 a.m.-4 p.m., with dinner available from 4-8:30 p.m.',
    ...
    phone: '(307) 734-4457',
    buttonText: 'Online Menu',
    buttonUrl: 'https://app.upserve.com/s/picas-mexican-taqueria-jackson-jackson',
    ...
    phone: '(307) 733-7392',
    buttonText: 'Online Menu',
    buttonUrl: 'https://us.orderspoon.com/cowboycoffee?fbclid=IwAR0-O6U-NMAeKquC8wMB92M-JVN5wdr2vQSz9SwJlGb-ErcHcccWVrxNXvw',
    menuUrl: ''
  }];
  return restaurants;
};
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../src/components/GetRecords.js":[function(require,module,exports) {
"use strict";
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.get('https://api.airtable.com/v0/appmXcO9crXbuzabT/Resturants?api_key=keyMkvcVnca6Qd4ZK');
...
var _Restaurants = _interopRequireDefault(require("./components/Restaurants"));

var _GetRecords = _interopRequireDefault(require("./components/GetRecords"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// import restaurants from './restaurants.js';
console.log('Connected');
var records = (0, _Restaurants.default)();
var restaurants;
hasTakeout(records);

function hasTakeout(arr) {
  restaurants = arr.filter(function (loc) {
    return loc.takeout === true;
  });
...
filters.innerHTML = (0, _Filters.default)(); // const restaurantList = document.getElementById('resturantList');
// console.log('resturantList', resturantList);

function hasMenuButton(obj) {
  if (obj.menuUrl !== '') {
    return "<button class='menu'>\n\t\t<a href='".concat(obj.menuUrl, "' target='_blank'>\n\t\t\tMenu\n\t\t</a>\n\t</button>");
  } else {
    return "";
  }
}
...
function loadCards() {
  for (var i = 0; i < restaurants.length; i++) {
    ...
    div.className = 'card';
    div.id = 'card';
    var content = "\n\t\t\t<h2>".concat(restaurants[i].restaurant, "</h2>\n\t\t\t<p class=\"phone\">\n\t\t\t<strong>Phone:\n\t\t\t</strong>").concat(restaurants[i].phone, "</p>\n\t\t\t<p class=\"hours\">\n\t\t\t\t<strong>Hours:</strong>\n\t\t\t\t").concat(restaurants[i].hours, "</p>\n\t\t\t<p class=\"description\">\n\t\t\t\t").concat(restaurants[i].description, "\n\t\t\t</p>\n\t\t\t<div class=\"actions\">\n\t\t\t\t<button class=\"order\">\n\t\t\t\t\t<a href=\"").concat(restaurants[i].buttonUrl, "\">\n\t\t\t\t\t").concat(restaurants[i].buttonText, "\n\t\t\t\t\t</a>\n\t\t\t\t</button>\n\t\t\t\t").concat(hasMenuButton(restaurants[i]), "\n\t\t\t</div>\n\t\t");
    df.appendChild(div);
...
var btnAll = document.getElementById('allOptions');
var btnOnlineOrdering = document.getElementById('onlineOrdering');
var btnTakeout = document.getElementById('takeout');
btnAll.addEventListener('click', function () {
  return loadCards();
});
btnOnlineOrdering.addEventListener('click', function () {
...
// };
},{"./components/Filters":"../src/components/Filters.js","./components/Restaurants":"../src/components/Restaurants.js","./components/GetRecords":"../src/components/GetRecords.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
